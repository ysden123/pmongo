 ...
 * @author Yuriy Stul
 */
public class Paginator1WithoutVertx {
    private static final Logger logger = LoggerFactory.getLogger(Paginator1WithoutVertx.class);
    ...
    private static long readPage(Paginator1 paginator, int pageSize, int pageNumber) {
